    ...
    <div className="flex flex-1 items-center justify-center px-6 py-16">
      <div className="w-full max-w-sm animate-fade-in-up text-center">
        <div className="rounded-xl border border-zinc-200/70 bg-zinc-50/80 px-8 py-10 dark:border-zinc-700/70 dark:bg-zinc-800/60">
          <div className="mx-auto mb-5 flex h-10 w-10 items-center justify-center rounded-full border border-zinc-200 bg-zinc-100 text-base text-zinc-500 dark:border-zinc-600 dark:bg-zinc-700 dark:text-zinc-300">
            ⛔
          </div>
